// better version - https://codepen.io/vsync/pen/waKju
...
(function(){
    Carousel = function(settings, obj){
        ...
        this.obj.on('click.container__slider', '.arrow.next', function(){ 
          that.movePage( that.pageIndex++ );
          return false; 
        });
        this.obj.on('click.container__slider', '.arrow.previous', function(){ 
          that.movePage( that.pageIndex-- );
          return false; 
        });
    ...
    Carousel.prototype = {
        pagination : function(){
            ...
            this.obj.on('click.container__slider', '> ul > li', function(){
    ...
    var defaults = {
        ...
        firstPage       : 'firstPage',      // class when reached the last item
        lastPage        : 'lastPage',      // class when reached the first item
    ...
    $.fn.carousel = function(settings){
        return this.each(function(){
            var $obj = $(this),
                ...
                carousel = $obj.data("container__slider") || new Carousel($settings, $obj),

            $obj.data("container__slider", carousel );
        });
    };

    // bind carousel elements
    $('.container__slider').carousel();
})();